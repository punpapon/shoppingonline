package com.somapait.shoppingonline.core.security.authorization.domain;
...
public enum PFCode {
	...
	, SHOPPING("10200100", "{'" + FunctionType.SEARCH + "':'10200101', '" + FunctionType.ADD + "':'10200102','" + FunctionType.EDIT + "':'10200103','" + FunctionType.VIEW + "':'10200104','" + FunctionType.CHANGE + "':'10200105'}")
	;
	// ---------: Program code and Function code :-----------
	// ---------: Fucntion code :-----------
